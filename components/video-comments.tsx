...
export default function VideoComments({ videoId }: { videoId: string }) {
  ...
  const [comments, setComments] = useState<Comment[]>([
    ...
    },
    {
      ...
      authorInitials: "DC",
      content:
        "I've been using this for years and each version keeps getting better. The performance improvements are incredible!",
      likes: 87,
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <Button variant="ghost" onClick={() => setShowComments(!showComments)} className="font-medium">
          ...
          {showComments ? (
            <ChevronUp className="ml-1 h-4 w-4" aria-hidden="true" tabIndex={-1} />
          ) : (
            <ChevronDown className="ml-1 h-4 w-4" aria-hidden="true" tabIndex={-1} />
          )}
        </Button>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      ...
                      <Button variant="ghost" size="icon" className="h-8 w-8">
                        <ThumbsDown className="h-4 w-4" aria-hidden="true" tabIndex={-1} />
                      </Button>
